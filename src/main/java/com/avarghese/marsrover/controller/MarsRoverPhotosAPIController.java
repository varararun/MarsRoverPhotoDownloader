...
public class MarsRoverPhotosAPIController {
	...
	public List<String> getMarsRoverPhotos(@PathVariable("date") String date,
		...
		log.info("Executing REST call with parameters, date={}, camera={}, limit={}, dryRun={}", date, camera, limit, dryRun);
		List<String> results = client.getPhotos(camera, date, limit, dryRun);
		return results;
	}
}
